...
class ReviewMeta extends Singleton
{
    ...
    public function outputReview(){
        ...
        <p> <label> Rating <br>
                <input type="radio" name="reviewRating" value="1" <?= $reviewRating == "1" ? 'checked' : '' ?> /> ★☆☆☆☆ <br>
                <input type="radio" name="reviewRating" value="2" <?= $reviewRating == "2" ? 'checked' : '' ?> /> ★★☆☆☆ <br>
                <input type="radio" name="reviewRating" value="3" <?= $reviewRating == "3" ? 'checked' : '' ?> /> ★★★☆☆ <br>
                <input type="radio" name="reviewRating" value="4" <?= $reviewRating == "4" ? 'checked' : '' ?> /> ★★★★☆ <br>
                <input type="radio" name="reviewRating" value="5" <?= $reviewRating == "5" ? 'checked' : '' ?> /> ★★★★★ <br>
            </label></p>
